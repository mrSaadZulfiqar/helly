...
<div class="credit-card-form">
    ...
    <form onsubmit="return false;">
     <fieldset>
        ...
        <div class="form-row first-last">
            ...
            <input name="cardholder-first-name" value="{{ $card_detail->first_name ?? "" }}" class="field input-box" placeholder="First Name">
            </div>

            <div class="form-group form-column">
            <!--<label for="">Last Name</label>-->
            <input name="cardholder-last-name" class="field input-box" value="{{ $card_detail->last_name ?? "" }}" placeholder="Last Name">
            </div>
    ...
    <fieldset>
        ...
        <input name="cardholder-address-1" class="field input-box" placeholder="Address 1" value="{{$card_detail->address1 ?? ""}}"> 
        </div>

        <div class="form-group first-last">
        <!--<label for="">Address 2</label>-->
        <input name="cardholder-address-2" class="field input-box" placeholder="Address 2" value="{{$card_detail->address2 ?? "" }}">
        </div>

        <div class="form-row first-last">
            <div class="form-group form-column">
            <!--<label for="">City</label>-->
            <input name="cardholder-city" class="field input-box" placeholder="City" value="{{$card_detail->city ?? ""}}">
            </div>
    ...
    <fieldset>
      ...
      <div class="form-row">
        <div class="form-group form-column">
          ...
          <input type="text" value="{{ $card_detail->exp_month ?? "" }}" id="expiry-month" name="month" size="3" maxlength="2" placeholder="MM">
        </div>

        <div class="form-group form-column">
          <label for="expiry-year">Expiry Year</label>
          <input type="text"  value="{{ $card_detail->exp_year ?? "" }}" id="expiry-year" name="year" size="5" maxlength="4" placeholder="YYYY">
        </div>
        
      </div>
</fieldset>
      <button id="paybutton">Pay $<?php echo $arrData['grandTotal']; ?></button>
...
staxJs.showCardForm().then(handler => {
  ...
  // for testing!
  handler.setTestPan('{{ $a }}');
  handler.setTestCvv('{{$card_detail->cvv ?? "" }}');
...
document.querySelector('#paybutton').onclick = () => {
  ...
  var extraDetails = {
    ...
    company: '',
    phone: '<?php echo $arrData['contactNumber'] ?? '00000000000'; ?>',
...
// document.querySelector("input#card_number").value = "{{ $card_detail->card_number ?? "" }}"
