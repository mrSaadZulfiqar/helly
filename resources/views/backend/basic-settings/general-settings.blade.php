        ...
        <form action="{{ route('admin.basic_settings.general_settings.update') }}" method="post"
          ...
          <div class="card-body">
            <div class="row">
              ...
              <div class="col-lg-8 mx-auto" style="display:none">
                ...
                <div class="row">
                  ...
                  <div class="col-lg-6">
                    <div class="form-group">
                      ...
                      <select name="subscription_enable" class="form-control ltr">
                        <option selected disabled>{{ __('Select') }}</option>
                        <option value="0" {{ $data->subscription_enable == '0' ? 'selected' : '' }}>
                          {{ __('Deactive') }}</option>
                        <option value="1" {{ $data->subscription_enable == '1' ? 'selected' : '' }}>
                          {{ __('Active') }}</option>
                      </select>
                      @if ($errors->has('subscription_enable'))
                        <p class="mb-0 text-danger">{{ $errors->first('subscription_enable') }}</p>
                      @endif
                    </div>
                  </div>
                    </div>
