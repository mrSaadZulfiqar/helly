          ...
          <div class="row no-gutters">
            <div class="col-lg-6">
              <div class="form-group">
                ...
                <input type="password" id="in_first_name" class="form-control" name="password"
                  placeholder="{{ __('Password') }}">
                  @error('password')
                        <p id="editErr_first_name" class="mt-2 mb-0 text-danger em">{{ $message }}</p>
                  @enderror
            ...
            <div class="col-lg-6">
              <div class="form-group">
                ...
                <input type="password" id="in_last_name" class="form-control" name="password_confirmation"
          ...
          <div class="row no-gutters">
            <div class="col-lg-6">
              <div class="form-group">
                ...
                <input type="text" class="form-control agcd-phone-intl" name="phone">
            ...
            <div class="col-lg-6">
              <div class="form-group">
                <label for="">{{ __('Message Bird Phone') }}</label>
                <input type="text" class="form-control agcd-phone-intl" name="message_bird_phone">
              </div>
            </div>

            <div class="col-lg-6">
              <div class="form-group">
                <label for="">{{ __('Voximplant Phone') }}</label>
                <input type="text" class="form-control agcd-phone-intl" name="voximplant_phone">
              </div>
            </div>
          </div>
          <!-- // code by AG end -->
