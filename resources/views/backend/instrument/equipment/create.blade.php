        ...
        <div class="card-body">
          <div class="row">
            <div class="col-lg-8 offset-lg-2">
              ...
              <div class="ml-2">
                <label for=""><strong>{{ __('Slider Images') . '*' }} <i data-toggle="tooltip" data-placement="top" title="Images are not required but recommended" class="fa fa-info-circle" aria-hidden="true"></i>
</strong></label>
              ...
              <form id="equipmentForm" action="{{ route('admin.equipment_management.store_equipment') }}"
                  ...
                  @foreach ($languages as $language)
                    <div class="version">
                      <div class="version-header" id="heading{{ $language->id }}">
                        <h5 class="mb-0">
                          <button type="button"
                            class="btn btn-sm btn-link {{ $language->direction == 1 ? 'rtl text-right' : '' }}"
                        ...
                        <div class="version-body">
                          <div class="row">
                            ...
                            <!-- <div class="col-lg-6">
                              <div class="form-group {{ $language->direction == 1 ? 'rtl text-right' : '' }}">
                                @php
                                  $locations = App\Models\Instrument\Location::where([['vendor_id', null], ['language_id', $language->id]])
                                      ->orderBy('id', 'desc')
                                      ->get();
                                @endphp
