...
@section('content')
  <div class="page-header">
    ...
    <div class="d-flex justify-content-end">
        <a class="btn btn-primary text-white btn-sm mb-3 float-right" href="{{ route('admin.user_management.create') }}"><i class="fa fa-plus"></i> Customer</a>
    </div>
  <div class="row">
    <div class="col-md-12">
      <div class="card">
                    ...
                    <tbody>
                      @foreach ($users as $user)
                        ...
                        <tr>
                          ...
                          <td>{{ $user->username . $user->accout_type }}</td>
                          <td>{{ $user->email }}</td>
                            <td>
                                @if($user->account_type == "corperate_account")
                                    {{ "Corporate Account" }}
                                @elseif($user->account_type == "indivisual_account")
                                    {{ "Individual Account" }}
                                @endif
                            </td>
                          <td>
                          ...
                          <td>
                            <div class="dropdown">
                              ...
                              <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                ...
                                <a href="{{ route('admin.user_management.change_account_type', ['id' => $user->id]) }}"
                                  class="dropdown-item">
                                  {{ __('Change Account type') }}
                                </a>
                                <a href="{{ route('admin.user_management.assign_to_vendor', ['id' => $user->id]) }}"
                                  class="dropdown-item">
                                  {{ __('Assign to Vendor') }}
                                </a>
