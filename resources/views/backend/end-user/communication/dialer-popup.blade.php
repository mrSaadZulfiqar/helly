...
<div id="call_dialer_parent">
            <div class="call_dialer_content">
                <form method="get" action="{{ route('admin_dialer.call') }}">
            ...
            <div class="call_dialer_main">
                <div>
                    <i class="fa fa-phone call_dialer_icon" id="call_dialer"></i>
                </div>
            </div>
        </div>
<script>
        $(document).ready(function(){
            $(document).on('click','#call_dialer',function(){
                $('.call_dialer_content').toggleClass('active');
                if($('.call_dialer_content').hasClass('active'))
                {
                    $('.call_dialer_content').show('slow');
                }else{
                    $('.call_dialer_content').hide('slow');
                }
