    ...
    <div class="col-md-12">
      <div class="card">
        <div class="card-header">
          <div class="row">
            <div class="col-lg-12">
              <div class="card-title">{{ __('Edit Driver') }}</div>
            </div>
          </div>
        </div>
          ...
          <div class="row">
            <div class="col-lg-8 mx-auto">
              <form id="ajaxEditForm"
                action="{{ route('admin.vendor_management.driver.update_driver', ['id' => $driver->id]) }}"
                method="post">
                @csrf
                <h2>Details</h2>
                <hr>
                <div class="row">
                  ...
                  <div class="col-lg-6">
                    <div class="form-group">
                      ...
                      <input type="text" value="{{ $driver->username }}" class="form-control" name="username">
                  ...
                  <div class="col-lg-6">
                    <div class="form-group">
                      ...
                      <input type="text" value="{{ $driver->email }}" class="form-control" name="email">
                      ...
                      <select class="form-control" name="vendor_id">
                        ...
                        <?php if( !empty($vendors)){ ?>
                            <?php foreach($vendors as $vendor){ ?>
                                <option <?php echo ($driver->vendor_id == $vendor['id'])?'selected':''; ?> value="<?php echo $vendor['id']; ?>"><?php echo $vendor['username']; ?></option>
                            <?php } ?>
                        <?php } ?>
                      </select>
                    </div>
