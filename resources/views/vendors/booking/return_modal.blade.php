  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">{{ __('Return Security Deposit') }}</h5>
      ...
      <div class="modal-body">
        <form id="ajaxForm" action="{{ route('vendor.equipment_booking.update_return_status') }}" method="POST">
          @csrf
