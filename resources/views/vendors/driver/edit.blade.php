    ...
    <div class="col-md-12">
      <div class="card">
        <div class="card-header">
          <div class="card-title d-inline-block">{{ __('Edit Driver') }}</div>
          ...
          <div class="row">
            <div class="col-lg-8 offset-lg-2">
              ...
              <form id="equipmentForm"
                action="{{ route('vendor.driver_management.update_driver', ['id' => $driver->id]) }}"
                              ...
                              <div class="row">
                                ...
                                <div class="col-lg-12">
                                  <div class="form-group">
                                    ...
                                    <input name="{{ $language->code }}_address" id="location_eq" class="form-control" value="{{ !empty($driver) ? $driver->address : '' }}" placeholder="{{ __('Enter Address') }}"/>
