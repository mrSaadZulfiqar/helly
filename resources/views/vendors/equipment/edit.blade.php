        ...
        <div class="row">
          <div class="col-lg-8 offset-lg-2">
            ...
            {{-- <div class="ml-2">
              ...
              @if (!is_null($sliderImages) && count($sliderImages) > 0)
                      ...
                      <tr class="table-row" id="{{ 'slider-image-' . $key }}">
                        <td>
                          <img class="thumb-preview wf-150"
                            src="{{ asset('assets/img/equipments/slider-images/' . $sliderImage) }}" alt="slider image">
                        </td>
                        <td>
                          <i class="fa fa-times-circle" onclick="rmvStoredImg({{ $equipment->id }}, {{ $key }})"></i>
                        </td>
                      </tr>
                      @endforeach
                    </table>
          ...
          <form id="equipmentForm"
            action="{{ route('vendor.equipment_management.update_equipment', ['id' => $equipment->id]) }}"
            ...
            <div id="accordion" class="mt-5">
              ...
              <div class="version">
                {{-- <div class="version-header" id="heading{{ $language->id }}">
                  <h5 class="mb-0">
                    <button type="button" class="btn btn-link {{ $language->direction == 1 ? 'rtl text-right' : '' }}"
                    ...
                    <div class="row">
                      ...
                      <div class="col-lg-6">
                        <div class="form-group {{ $language->direction == 1 ? 'rtl text-right' : '' }}">
                          ...
                          <select name="{{ $language->code }}_category_id" class="form-control">
                            ...
                            <option value="{{ $category->id }}" {{ !empty($equipmentData) && $category->id ==
                              $equipmentData->equipment_category_id ? 'selected' : '' }}>
                              {{ $category->name }}
                            </option>
                      ...
                      <!-- <div class="col-lg-6">
                              <div class="form-group {{ $language->direction == 1 ? 'rtl text-right' : '' }}">
                                ...
                                <select name="{{ $language->code }}_location_ids[]" class="form-control select2"
                                  multiple>
                      ...
                      <div class="col">
                        <div class="form-group {{ $language->direction == 1 ? 'rtl text-right' : '' }}">
                          ...
                          <textarea class="form-control" name="{{ $language->code }}_features"
                            placeholder="{{ __('Enter Equipment Features') }}"
                            rows="7">{{ is_null($equipmentData) ? '' : $equipmentData->features }}</textarea>
                      ...
                      <div class="col">
                        <div class="form-group {{ $language->direction == 1 ? 'rtl text-right' : '' }}">
                          ...
                          <textarea class="form-control summernote" name="{{ $language->code }}_description"
                            placeholder="{{ __('Enter Equipment Description') }}"
                            data-height="300">{{ is_null($equipmentData) ? '' : replaceBaseUrl($equipmentData->description, 'summernote') }}</textarea>
                        </div>
                      </div>
                    </div>
            ...
            <div class="row">
              ...
              <div class="col-lg-6">
                <div class="form-group">
                  ...
                  <input type="number" class="form-control" name="offer" placeholder="{{ __('Enter Offer Amount') }}"
                    value="{{ $equipment->offer }}">
                </div>
              </div>
            </div>
              ...
              <div class="col-lg-6">
                <div class="form-group">
                  ...
                  <select class="form-control" name="location_id" required>
                    @foreach($locations as $location)
                    <option value="{{ $location->id }}" @if($location->id == $equipment->location_id) selected @endif>{{
...
<script>
  'use strict';
    ...
    const imgDetachUrl = "{{ route('vendor.equipment_management.detach_slider_image') }}";
</script>
