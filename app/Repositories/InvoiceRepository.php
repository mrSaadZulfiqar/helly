...
class InvoiceRepository extends BaseRepository
{
    ...
    public function saveInvoice(array $input): Invoice
    {
        try {
            ...
            $invoiceItemInputArray = Arr::only($input, ['product_id', 'quantity', 'price', 'tax', 'tax_id', 'job_number', 'po_number']);
    ...
    public function updateInvoice($invoiceId, $input)
    {
        try {
            ...
            $inputInvoiceTaxes = isset($input['taxes']) ? $input['taxes'] : [];
            $invoiceItemInputArr = Arr::only($input, ['product_id', 'quantity', 'price', 'tax', 'tax_id', 'id', 'job_number', 'po_number']);
