...
//       foreach($equipments as $serial => $equipment){
//             $equipment_fields_value = EquipmentFieldsValue::where('equipment_id', $equipment->id)->first();
//             $equipment_fields_value = json_decode($equipment_fields_value->multiple_charges_settings);
//             if($equipment_fields_value != ""){
//                 if(gettype($equipment_fields_value) != "array"){
//                     $equipment_fields_value->base_price;        
//                     $eq_update = Equipment::find($equipment->id);
//                     $eq_update->base_price = $equipment_fields_value->base_price;
//                     $eq_update->update();
//                     echo $serial. "<br />";
//                 }
//             }
