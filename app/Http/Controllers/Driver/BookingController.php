...
class BookingController extends Controller
{
    ...
    public function updateShippingStatus(Request $request, $id)
    {
        ...
        $vendor_->notify(new BasicNotify('<a href="/vendor/equipment-booking/'. $booking->id .'/details?language=en">Hi ' . $vendor_->username . ',<br/><br/>This notification is to notify the shipping status of booking #' . $booking->booking_number .' : '. $statusMsg . '</a>'));
