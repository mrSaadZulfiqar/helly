...
class Kernel extends HttpKernel
{
  ...
  protected $middlewareGroups = [
    ...
    //   \App\Http\Middleware\RedirectMobileDevices::class,
    ],
  ...
  protected $routeMiddleware = [
    ...
    'checkPlanFeaturesAccess' => \App\Http\Middleware\CheckPlanFeaturesAccess::class,
    'checkVendorPlan' => \App\Http\Middleware\CheckVendorPlan::class
  ];
}
